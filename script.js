...
function calculateAge() {
  ...
  } else if (d3 > 1 && m3 <= 1 && y3 <= 1) {
    result.innerHTML = `You are <span>${y3}</span> year, <span>${m3}</span> month and <span>${d3}</span> days old.`;
  } else if (d3 <= 1 && m3 > 1 && y3 <= 1) {
    result.innerHTML = `You are <span>${y3}</span> year, <span>${m3}</span> months and <span>${d3}</span> day old.`;
  } else if (d3 <= 1 && m3 <= 1 && y3 > 1) {
    result.innerHTML = `You are <span>${y3}</span> years, <span>${m3}</span> month and <span>${d3}</span> day old.`;
  } else if (d3 > 1 && m3 > 1 && y3 <= 1) {
